...
import { FaBars, FaClipboard, FaMagnifyingGlass, FaUser, FaX } from "react-icons/fa6"
                ...
                <motion.div className={`flex justify-end h-screen overflow-hidden`}>
                    <div className="min-w-[300px] h-full flex flex-col  bg-blue-50 border border-l ">
                        <div className="flex px-5 py-5 justify-between w-full">
                            ...
                            <FaX className='md:hidden cursor-pointer flex text-blue-400' onClick={() => setMenu(false)} />
                        </div>
            ...
            <div className="flex flex-col w-full">
                <div className="flex justify-between items-center px-4 py-2 bg-blue-50 w-full">
                    <div className="">
                        ...
                        <form className='flex items-center justify-center bg-white gap-2 px-2 rounded-full' action="" method='post'>
                            <input type="text" placeholder='Search' className='font-light outline-none py-1 text-sm text-gray-600' /><button type="submit"><FaMagnifyingGlass/></button>
                        </form>
                    </div>
                    <div className="flex gap-2 items-center">
                        <Image src={'data:image/jpeg;base64,'} height={30} width={30} className='rounded-full' />
                        <div className="flex flex-col">
                            <h1 className='text-gray-900 text-[13px] font-light'>Naruto uzumaki</h1>
                            <p className='text-[12px] font-thin'>Student</p>
                        </div>
                    </div>
                </div>
