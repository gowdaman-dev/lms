            ...
            <div className="flex flex-col w-full">
                <div className="flex justify-between items-center px-4 py-2 bg-blue-50 w-full">
                    <div className=" flex items-center justify-center gap-2">
                        ...
                        <form action="" className='bg-white px-2 py-1 rounded-full justify-center items-center' method='post'>
                            <input type="text" className='outline-none text-sm font-light px-2' placeholder='search...' />
                            <button><FaMagnifyingGlass className='text-gray-800' /></button>
                        </form>
                    </div>
                    <div className="flex gap-2 items-center py-2">
