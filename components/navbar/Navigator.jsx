        ...
        <AnimatePresence mode='wait'>
          {menu && (
            <motion.div
              ...
              className=' flex justify-end h-screen overflow-hidden'
            >
              <div className='min-w-[300px] h-full flex flex-col  bg-blue-50 border border-l '>
                <div className='flex px-5 py-5 justify-between w-full'>
                  <h1 className=' w-full  text-xl text-blue-500 tracking-wide font-bold'>
                    EDULEARN
                  </h1>
                  <FaX
                    className='md:hidden flex text-blue-400'
